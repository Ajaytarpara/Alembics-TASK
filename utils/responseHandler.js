...
const responseHandler = (req, res, next) => {
  ...
  res.successWithNullMessage = (data) => {
    message.successWithNullMessage(data, res);
  };
  res.successMessage = (msg, data) => {
    message.successMessage(msg, data, res);
  };
  res.validationErrorMessage = (msg, data) => {
    message.validationErrorMessage(msg, data, res);
  };
  next();
};
